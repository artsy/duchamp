...
**Labels Applied:**
- `Version: Major` - Breaking changes (red)
- `Version: Minor` - New features (blue)
- `Version: Patch` - Bug fixes (green)
...
```yaml
uses: artsy/duchamp/.github/workflows/run-danger-yarn.yml@v1.2.3
```

### Development Approach

Use `@main` for testing new features:
